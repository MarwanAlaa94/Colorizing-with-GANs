...
if MODE == 1:
    ...
    for e in range(EPOCHS):
        ...
        if e % 10 == 0:
            ...
            print('')
            model_gen.save_weights(WEIGHTS_GEN, overwrite=False)
            model_dis.save_weights(WEIGHTS_DIS, overwrite=False)
            model_gan.save_weights(WEIGHTS_GAN, overwrite=False)
